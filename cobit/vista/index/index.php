...
<div class="container">
    <div class="bs-docs-example row">
        ...
        <?php }?>
        <a class="btn btn-large span3" title="Usuarios" style="margin-bottom:10px;" href="<?php echo URL; ?>area" data-content="">
        ...
        <a class="btn btn-large span3" title="Usuarios" style="margin-bottom:10px;" href="<?php echo URL; ?>tproceso" data-content="">
            <i class="icon-list-ol icon-4x"></i>
            <h3>Tproceso</h3>
        </a>

       <a class="btn btn-large span3" style="margin-bottom:10px;" title="Usuarios" href="<?php echo URL; ?>analista" >
        ...
        <a class="btn btn-large span3" title="Usuarios" style="margin-bottom:10px;" href="<?php echo URL; ?>registro" data-content="">
