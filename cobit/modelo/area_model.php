...
class Area_Model extends Modelo{
...
function __construct() {
    ...
    public function listarAreas(){
        ...
        $sql='SELECT id_area ,nombre_area, nombre FROM area INNER JOIN pais on pais.id_pais= area.id_pais';
    ...
    public function listarAreaIndividual($id){
