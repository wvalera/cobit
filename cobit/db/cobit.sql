...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2014 at 10:23 PM
...
INSERT INTO `analista` (`id_an`, `analista`, `fecha_ingreso`, `correo`, `contacto`, `id_area`, `descripcion`) VALUES
(1, 'Wilkeins valera', '2014-11-30', 'wilkeins.pepsico.com', '04262556539', '1', 'asdsadad'),
(2, 'Nuevo', '2014-11-30', 'wilkeins.valera@pepsico.com', '04262556539', '2', 'asdasdasasdas');
...
INSERT INTO `aplicacion` (`id_ap`, `aplicacion`, `version_ap`, `descripcion`) VALUES
(1, 'NUEVA_APLICACION', 'VERSION 1.0', 'NUEVA_VERSION');
...
INSERT INTO `registro` (`id_rg`, `registro`, `documentacion`, `procedimiento`, `nivel_impacto`, `statuss`, `id_area`, `id_usuario`, `id_tp`, `id_cliente`, `id_dev`, `id_ap`, `id_an`, `fecha_creacion`, `fecha_modificacion`) VALUES
(1, 'REGISTRO_A', 'DOCUMENTACION_A', 'PROCEDIMIENTO_A', 'ALTO', 'BUENO', '1', '1', '1', '1', '1', '1', '1', '2014-12-01 00:00:00', '2014-12-01 00:00:00'),
(2, 'REGISTRO_B', 'DOCUMENTACION_B', 'PROCEDIMIENTO_B', 'BAJO', 'MEDIO', '2', '1', '2', '2', '2', '1', '2', '2014-12-01 00:00:00', '2014-12-01 00:00:00');
